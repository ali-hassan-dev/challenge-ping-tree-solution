...
var constants = require('../lib/constants').API_URLS
...
router.set(constants.TARGETS, { POST: postTargets, GET: getTargets })
router.set(constants.TARGET_BY_ID + ':id', { GET: getTargetById, POST: putTargetById })
router.set(constants.ROUTE, { POST: postRoute })
